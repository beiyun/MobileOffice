...
//            throw new UnknownError("create session fail!");
        ...
        webView = (WebView) findViewById(R.id.message_list_detail_webView);
        ...
        progressBar = findViewById(R.id.message_list_detail_progress);
        ...
        webView.setWebChromeClient(new WebChromeClient(){
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                com.beiyun.library.util.Logs.e("onProgressChanged >"+newProgress);
                if(newProgress == 100){
...
//        webSettings.setTextZoom(150);
    ...
    public void receive(MessageEntity entity){
        ...
        com.beiyun.library.util.Logs.e("receive >>" + entity.toString());
    }
}
